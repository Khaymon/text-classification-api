...
from src.lib.models import ModelsFactory, ModelType
...
class LocalArtifactStorage(ArtifactStorageInterface):
    ...
    def save(self, artifact: ModelInterface, dataset_name: str) -> str:
    ...
    def load(self, artifact_name: str) -> ModelInterface:
        ...
        return ModelsFactory.get_model_class(ModelType(model_name)).load(
